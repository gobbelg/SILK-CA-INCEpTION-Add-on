...
public class ProbabilisticRecommenderPlugin
    extends Plugin
{
    public ProbabilisticRecommenderPlugin(PluginWrapper aWrapper)
    {
        super(aWrapper);
    }
    ...
    {
        return singleton(ProbabilisticRecommenderFactory.class);
    }
}
