...
@Component
public class ProbabilisticRecommenderFactory
    extends RecommendationEngineFactoryImplBase<Void>
{
    public static final String ID = "org.vumc.dbmi.ciphi.SilkCAProbabilisticRecommender";
    ...
    {
        return new ProbabilisticRecommender(aRecommender);
    }

    @Override
    public String getName()
    {
        return "SilkCAProbabilisticRecommender";
    }
